    ...
    <div style={{ minHeight: '100vh', background: '#080c14', color: '#f0f0f0', padding: '48px 20px' }}>
      <div style={{ maxWidth: 720, margin: '0 auto', lineHeight: 1.8 }}>
        ...
        <Section title="第1条（適用）">
          <p>本利用規約（以下「本規約」）は、ITO Yuichi（以下「当社」）が提供するSpotCast（以下「本サービス」）の利用に関する条件を定めるものです。ユーザーは本規約に同意した上で本サービスを利用するものとします。</p>
        </Section>
        ...
        <Section title="第6条（免責事項）">
          <ul>
            <li>本サービスが提供する気象情報・農業情報は参考情報であり、正確性・完全性を保証するものではありません。</li>
