  ...
  return (
    <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
      <svg width={size} height={size} viewBox="0 0 40 40" fill="none">
        <defs>
          <radialGradient id="lgMain" cx="50%" cy="50%" r="50%">
            <stop offset="0%" stopColor="#38bdf8"/>
            <stop offset="100%" stopColor="#2563eb"/>
          </radialGradient>
        </defs>
        <circle cx="20" cy="20" r="19"
          fill={dark ? 'rgba(255,255,255,0.08)' : 'rgba(37,99,235,0.07)'}
          stroke={dark ? 'rgba(255,255,255,0.14)' : 'rgba(37,99,235,0.18)'}
          strokeWidth="1"/>
        <path d="M9 20 A13 13 0 0 1 20 7"  stroke="#38bdf8" strokeWidth="2"   strokeLinecap="round" opacity="0.55"/>
        <path d="M31 20 A13 13 0 0 0 20 7" stroke="#2563eb" strokeWidth="2"   strokeLinecap="round" opacity="0.38"/>
        ...
        <path d="M20 13.5 C17 13.5 14.5 16 14.5 19 C14.5 22.8 20 28.5 20 28.5 C20 28.5 25.5 22.8 25.5 19 C25.5 16 23 13.5 20 13.5Z" fill="url(#lgMain)"/>
