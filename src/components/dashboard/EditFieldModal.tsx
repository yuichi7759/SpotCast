      ...
      <div style={modalStyle}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 22 }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
            ...
            <div>
              <div style={{ fontWeight: 800, fontSize: 16, color: '#fff', lineHeight: 1 }}>ポイントを編集</div>
              <div style={{ fontSize: 11, color: 'rgba(255,255,255,0.35)', marginTop: 3 }}>{coordPreview}</div>
            </div>
          </div>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 15 }}>
          ...
          <div>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 8 }}>
              <div>
                <div style={{ fontSize: 10, color: 'rgba(255,255,255,0.3)', marginBottom: 4 }}>緯度 (lat)</div>
                <input style={inputStyle} placeholder="35.6762" value={coordLat} onChange={e => setCoordLat(e.target.value)}/>
              </div>
              <div>
                <div style={{ fontSize: 10, color: 'rgba(255,255,255,0.3)', marginBottom: 4 }}>経度 (lng)</div>
          ...
          <div style={{ display: 'flex', gap: 10, marginTop: 4 }}>
            ...
            <button onClick={handleSave} disabled={saving} style={{
              ...
              background: saving ? 'rgba(255,255,255,0.08)' : 'linear-gradient(135deg, #3ecf8e, #059669)',
            ...
            <div style={{ borderTop: '1px solid rgba(255,255,255,0.06)', paddingTop: 14 }}>
              {!confirmDel ? (
                ...
                <div style={{ display: 'flex', gap: 8, alignItems: 'center' }}>
                  <div style={{ fontSize: 13, color: 'rgba(255,255,255,0.5)', flex: 1 }}>本当に削除しますか？</div>
